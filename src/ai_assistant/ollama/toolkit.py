...
from ollama import (
    ...
    StatusResponse, Message, Tool, Options, ResponseError
)
...
class OllamaToolkit:
    ...
    def chat(
        ...
        """
        # Prepare kwargs, only include images if provided
        kwargs = {
            'model': model,
            'messages': messages,
            'stream': stream,
        ...
        return self.sync_client.chat(**kwargs)
    ...
    def web_search(self, query: str, max_results: int = 3) -> Dict[str, Any]:
        ...
        """
        # Note: This feature may not be available in all Ollama versions
